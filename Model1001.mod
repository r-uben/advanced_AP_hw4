...
dy=mu+x(-1)+rho_vecm*EC+eps_c; 
dyf=mu+xf(-1)+rho_vecm*EC+eps_cf; 
x=rho*x(-1)+eps_x; 
xf=rho*xf(-1)+eps_xf; 
...
exp((1-1/psi)*uf)=(1-delta)+delta*(CE^theta); 
...
vcov = [3.499200e-04 1.224720e-04 0 0
1.224720e-04 3.499200e-04 0 0
